...
do
    ...
    do
        ...
        do
            ...
            echo ${workload[$windex]}" "${ratem[$rindex]}" "$tm" "$pt" "$er" "$per >> detailed-prediction-error-base.txt
...
./get_cdf.sh prediction-error-percent-sorted-base.txt > sample-cdf-error-percent-base.txt
...
./get_cdf.sh prediction-error-percent-sorted-infocom.txt > sample-cdf-error-percent-infocom.txt
...
./get_cdf.sh prediction-error-percent-sorted-effective-rate.txt > sample-cdf-error-percent-effective-rate.txt
...
./get_cdf.sh prediction-error-value-sorted-base.txt > sample-cdf-error-value-base.txt
...
./get_cdf.sh prediction-error-value-sorted-infocom.txt > sample-cdf-error-value-infocom.txt
...
./get_cdf.sh prediction-error-value-sorted-effective-rate.txt > sample-cdf-error-value-effective-rate.txt
