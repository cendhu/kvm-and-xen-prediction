...
./get_cdf.sh prediction-error-percent-sorted-base-$1.txt > pacer-cdf-error-percent-base-$1.txt
...
./get_cdf.sh prediction-error-percent-sorted-infocom-$1.txt > pacer-cdf-error-percent-infocom-$1.txt
...
./get_cdf.sh prediction-error-percent-sorted-effective-rate-$1.txt > pacer-cdf-error-percent-effective-rate-$1.txt
...
./get_cdf.sh prediction-error-value-sorted-base-$1.txt > pacer-cdf-error-value-base-$1.txt
...
./get_cdf.sh prediction-error-value-sorted-infocom-$1.txt > pacer-cdf-error-value-infocom-$1.txt
...
./get_cdf.sh prediction-error-value-sorted-effective-rate-$1.txt > pacer-cdf-error-value-effective-rate-$1.txt
